            ...
            >
              ...
              <div className="flex justify-center mt-6">
                <button
                  ...
                  className={`px-6 py-2 rounded-xl text-white transition-all duration-300
                  ${
                    cart.some(
                      (cartItem) =>
                        cartItem.title === item.title &&
                        cartItem.size ===
                          (selectedSizes[item.title] || "L")
                    )
                      ? "bg-green-500 cursor-pointer rotate-scale"
                      : "cursor-pointer bg-orange-400"
                  }`}
...
{/* <div className={grid gap-8 transition-all duration-500 grid-cols-2 ${showOrders ? "md:grid-cols-3 gap-17" : "md:grid-cols-5"} }></div> */}
