...
//     return (
//         <div className="fixed inset-0 bg-black/60 z-50 flex lg:items-center lg:justify-center items-center">
//             <div className="bg-[#1F1D2B] text-white w-96 rounded-2xl p-6 relative">
...
//                 <div className="border-t border-gray-700 pt-3 space-y-3 max-h-60 overflow-y-auto">
//                     {cart.map((item, i) => (
...
//                 <button className="mt-5 w-full bg-[#F99147] py-3 rounded-md">
//                     Confirm Order
//                 </button>
//             </div>
